...
/**
 * This is the base class for all test scenario classes. It includes methods returning the instance of Appium driver and driver wait
 * and beforesuite and aftersuite methods
 */
public class Hooks {
    ...
    public void tearDown() throws Exception {
        DriverWrapper.driver().closeApp();
        System.out.println("Hooks: Test suite completed. Appium driver is NOT quit,  closeApp has been called");
    }
